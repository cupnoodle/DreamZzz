...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // if the root view controller is a navigation controller, and the first view controller is dream list VC
    ...
    func saveDream(from viewController: EditDreamViewController) {
        ...
        if let existingDream = viewController.dream, let indexOfExistingDream = dataModel.dreams.firstIndex(of: existingDream) {
