...
class EditDreamViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        isLucidSwitch.onTintColor = UIColor.darkGray
        ...
        moodSegementedController.tintColor = UIColor.white
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        deleteCell.backgroundColor = UIColor.white
...
//            }
    ...
    @objc func hideKeyboard(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        if !isDreamDatePickerHidden {
            ...
            dreamDateLabel.textColor = isDreamDatePickerHidden ? .white : tableView.tintColor
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case dreamDateCell:
            isDreamDatePickerHidden = !isDreamDatePickerHidden
            dreamDateLabel.textColor = isDreamDatePickerHidden ? .white : UIColor.white
            tableView.beginUpdates()
            tableView.endUpdates()
    ...
    func showMicrophoneAccessDeniedAlert() {
        let alert = UIAlertController(title: NSLocalizedString("Microphone Access Disabled", comment: ""),
                                      message: NSLocalizedString("To record voice memos, please allow access to the microphone for Sui in Settings.", comment: ""),
                                      preferredStyle: .alert)
